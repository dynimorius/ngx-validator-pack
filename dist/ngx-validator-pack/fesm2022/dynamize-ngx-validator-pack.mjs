...
import { checkFactory as checkFactory$1, regexpValidator as regexpValidator$1 } from 'ngx-validator-pack';
...
// @internal Checks if input is an email
const advancedEmail = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/;
...
const cidrV4 = /^(3[0-2]|[12]?[0-9])$/;
// @internal Checks if input is in a ipv6 cidr address format
const cidrV6 = /^(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/;
...
const alphaNumericWithSpace = /^[0-9a-zA-Z\s]+$/;
...
const localhostUrl = /^(https?:\/\/localhost\:([1-9][0-9]{0,3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])|localhost\::([1-9][0-9]{0,3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5])|https?:\/\/localhost\::([1-9][0-9]{0,3}|[1-5][0-9]{4}|6[0-4][0-9]{3}|65[0-4][0-9]{2}|655[0-2][0-9]|6553[0-5]))$/;
// @internal Checks if input is an internal url
const interanetUrl = /^(https?:\/\/[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9])$/;
// @internal Checks if input is a data URI
const dataUri = /^data:([a-z]+\/[a-z0-9-+.]+(;[a-z0-9-.!#$%*+.{}|~`]+=[a-z0-9-.!#$%*+.{}|~`]+)*)?(;base64)?,([a-z0-9!$&',()*+;=\-._~:@\/?%\s]*?)$/i;
...
// @internal Checks if input is in a hex color format
const strictHexColor = /^#?([0-9A-F]{3}|[0-9A-F]{6})$/i;
 ...
 * found at https://www.isc.org/licenses/
 */
const AddressChecks = () => checkFactory$1([
    {
        validator: regexpValidator$1,
        args: [/(\d{1,})/, '!!'],
